...
//         style={{
//           backgroundImage:
//             "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23B76E79' fill-opacity='0.07'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
//         }}
//       />
...
//                 y: imageY,
//                 boxShadow:
//                   "0 40px 100px rgba(183,110,121,0.2), 0 10px 30px rgba(0,0,0,0.1)",
//               }}
//             >
...
//                 style={{
//                   background:
//                     "linear-gradient(to top, rgba(26,10,10,0.4) 0%, transparent 50%)",
//                 }}
//               />
//             </motion.div>
...
//                   style={{
//                     background: "linear-gradient(135deg, #B76E79, #E8C4B8)",
//                   }}
//                 >
...
//             >
//               <p>
//                 Galaxy Beauty Salon was founded in 2012 in Maharajganj with a
//                 single belief: every woman deserves to feel extraordinary. We
//                 built a space where premium expertise meets genuine care — and
//                 the results speak for themselves.
//               </p>
//               <p>
//                 Over a decade later, we have served thousands of clients across
//                 bridal, party, and everyday beauty — and we are still driven by
...
//             </h3>
//             <p
//               className="font-sans text-sm mt-2 font-light"
//               style={{ color: "#8B6F6F" }}
//             >
...
//             {team.map((member, i) => (
//               <motion.div
//                 style={{ y: imageY }} // <--- FIRST STYLE PROP
//                 className="relative z-10 rounded-2xl overflow-hidden"
//                 style={{
//                   // <--- SECOND STYLE PROP (This causes the error)
//                   y: imageY,
//                   boxShadow:
//                     "0 40px 100px rgba(183,110,121,0.2), 0 10px 30px rgba(0,0,0,0.1)",
//                 }}
