...
export const metadata: Metadata = {
  title: "Pricing & Membership | Galaxy Beauty Salon",
  description: "Transparent pricing and exclusive membership plans at Galaxy Beauty Salon, Maharajganj. Find the plan that fits your lifestyle.",
};
        ...
        >
          ...
          <div className="relative max-w-3xl mx-auto px-4">
            ...
            <p className="font-cormorant text-xl font-light" style={{ color: "rgba(255,255,255,0.5)" }}>
              No hidden charges. No surprises. Just great value.
            </p>
          </div>
        </div>
        <PricingSection />
